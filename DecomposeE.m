...
% R: Rotation matrix corresponding to second image
...
ind_num = unidrnd(1154);
[X0,R] = GetRelOr(X01,X02,R1,R2,K,K,pointsImg1(:,ind_num),pointsImg2(:,ind_num));  % Hint: Use GetRelOr function here
end